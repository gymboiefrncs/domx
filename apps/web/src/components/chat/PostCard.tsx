    ...
    <div className="flex flex-col gap-3">
      {isEditing ? (
        ...
        <>
          ...
          <div className="border-l-3 rounded-bl-lg rounded-tl-lg border-primary/50 p-2 pl-3 md:pl-4">
            <div className="wrap-break-word max-h-72 overflow-y-auto rounded-md border p-2 text-sm text-text-muted md:max-h-96 md:text-base">
